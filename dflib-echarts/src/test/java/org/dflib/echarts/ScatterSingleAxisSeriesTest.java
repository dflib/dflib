...
public class ScatterSingleAxisSeriesTest {
    ...
    public void coordinateSystem() {
        String s3 = ECharts.chart().series(SeriesOpts.ofScatterSingleAxis(), "y1").plot("_tid", df4).renderChartScript();
        assertTrue(s3.contains("coordinateSystem: 'singleAxis'"), s3);
    }

    @Test
    public void singleAxisIndex() {
        String s3 = ECharts.chart().series(SeriesOpts.ofScatterSingleAxis().singleAxisIndex(1), "y1").plot("_tid", df4).renderChartScript();
    ...
    public void data() {
        ...
        String s2 = ECharts.chart()
                ...
                .series(SeriesOpts.ofScatterSingleAxis(), "y2").plot("_tid", df4).renderChartScript();
