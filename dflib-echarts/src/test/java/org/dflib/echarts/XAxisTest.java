...
public class XAxisTest {
    ...
    public void data() {
        ...
        String s2 = ECharts.chart().series("y1").plot("_tid", df2).renderChartScript();
        assertTrue(s2.contains("['L0',1,2,3]"), s2);
        assertTrue(s2.contains("type: 'category'"), s2);

        String s3 = ECharts.chart().xAxis("x").series(SeriesOpts.ofLine(), "y1").plot("_tid", df2).renderChartScript();
        assertTrue(s3.contains("['L0','A','B','C']"), s3);
        assertTrue(s3.contains("type: 'category'"), s3);

        String s4 = ECharts.chart().xAxis(XAxis.ofCategory()).series("y1").plot("_tid", df2).renderChartScript();
    ...
    public void boundaryGap() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().boundaryGap(false)).plot("_tid", df1).renderChartScript();
        assertTrue(s2.contains("boundaryGap: false,"), s2);

        String s3 = ECharts.chart().xAxis("x", XAxis.ofDefault().boundaryGap(true)).plot("_tid", df1).renderChartScript();
    ...
    public void name() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().name("I'm an X")).plot("_tid", df1).renderChartScript();
    ...
    public void position() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().top()).plot("_tid", df1).renderChartScript();
    ...
    public void offset() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().offset(-5)).plot("_tid", df1).renderChartScript();
    ...
    public void gridIndex() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().gridIndex(2)).plot("_tid", df1).renderChartScript();
    ...
    public void alignTicks() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().alignTicks(true)).plot("_tid", df1).renderChartScript();
        assertTrue(s2.contains("alignTicks: true,"), s2);

        String s3 = ECharts.chart().xAxis("x", XAxis.ofDefault().alignTicks(false)).plot("_tid", df1).renderChartScript();
    ...
    public void axisLine() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().line(AxisLine.of())).plot("_tid", df1).renderChartScript();
        assertTrue(s2.contains("axisLine: {"), s2);
        assertTrue(s2.contains("show: true"), s2);
        assertFalse(s2.contains("onZero:"), s2);

        String s3 = ECharts.chart().xAxis("x", XAxis.ofDefault().line(AxisLine.of().show(false))).plot("_tid", df1).renderChartScript();
        assertTrue(s3.contains("axisLine: {"), s3);
        assertTrue(s3.contains("show: false"), s3);
        assertFalse(s3.contains("onZero:"), s3);

        String s4 = ECharts.chart().xAxis("x", XAxis.ofDefault().line(AxisLine.of().onZero(false))).plot("_tid", df1).renderChartScript();
    ...
    public void label_formatter() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().label(AxisLabel.of().formatter("{value} cm"))).plot("_tid", df1).renderChartScript();
    ...
    public void label_rotate() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().label(AxisLabel.of().rotate(-20))).plot("_tid", df1).renderChartScript();
        assertTrue(s2.contains("axisLabel: {"), s2);
    ...
    public void label_font() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().label(AxisLabel.of()
                ...
                .fontWeight(200))).plot("_tid", df1).renderChartScript();
        assertTrue(s2.contains("axisLabel: {"), s2);
