...
public class XAxisTest {
    ...
    public void data() {
        ...
        String s2 = ECharts.chart().series("y1").generateScript("_tid", df2);
        assertTrue(s2.contains("['L0',1,2,3]"), s2);
        assertTrue(s2.contains("type: 'category'"), s2);

        String s3 = ECharts.chart().xAxis("x").series(SeriesOpts.ofLine(), "y1").generateScript("_tid", df2);
    ...
    public void boundaryGap() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().boundaryGap(false)).generateScript("_tid", df1);
        assertTrue(s2.contains("boundaryGap: false,"), s2);

        String s3 = ECharts.chart().xAxis("x", XAxis.ofDefault().boundaryGap(true)).generateScript("_tid", df1);
    ...
    public void name() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().name("I'm an X")).generateScript("_tid", df1);
    ...
    public void position() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().top()).generateScript("_tid", df1);
    ...
    public void offset() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().offset(-5)).generateScript("_tid", df1);
    ...
    public void gridIndex() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().gridIndex(2)).generateScript("_tid", df1);
    ...
    public void alignTicks() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().alignTicks(true)).generateScript("_tid", df1);
        assertTrue(s2.contains("alignTicks: true,"), s2);

        String s3 = ECharts.chart().xAxis("x", XAxis.ofDefault().alignTicks(false)).generateScript("_tid", df1);
    ...
    public void axisLine() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().line(AxisLine.of())).generateScript("_tid", df1);
        assertTrue(s2.contains("axisLine: {"), s2);
        assertTrue(s2.contains("show: true"), s2);
        assertFalse(s2.contains("onZero:"), s2);

        String s3 = ECharts.chart().xAxis("x", XAxis.ofDefault().line(AxisLine.of().show(false))).generateScript("_tid", df1);
        assertTrue(s3.contains("axisLine: {"), s3);
        assertTrue(s3.contains("show: false"), s3);
        assertFalse(s3.contains("onZero:"), s3);

        String s4 = ECharts.chart().xAxis("x", XAxis.ofDefault().line(AxisLine.of().onZero(false))).generateScript("_tid", df1);
    ...
    public void label_formatter() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().label(AxisLabel.of().formatter("{value} cm"))).generateScript("_tid", df1);
    ...
    public void label_rotate() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().label(AxisLabel.of().rotate(-20))).generateScript("_tid", df1);
        assertTrue(s2.contains("axisLabel: {"), s2);
    ...
    public void label_font() {
        ...
        String s2 = ECharts.chart().xAxis("x", XAxis.ofDefault().label(AxisLabel.of()
                ...
                .fontWeight(200))).generateScript("_tid", df1);
        assertTrue(s2.contains("axisLabel: {"), s2);
