...
public class SeriesTest {
    ...
    public void series() {
        ...
        String s2 = ECharts.chart().series("y2").plot("_tid", df2).renderChartScript();
        ...
        String s3 = ECharts.chart().series("y2", "y1").plot("_tid", df2).renderChartScript();
    ...
    public void timeSeries() {
        ...
        String s2 = ECharts.chart().series("y2").xAxis("t", XAxis.ofTime()).plot("_tid", df3).renderChartScript();
        assertTrue(s2.contains("series: ["), s2);
        assertTrue(s2.contains("name: 'y2',"), s2);
        assertTrue(s2.contains("['L0','2022-01-01','2022-02-01','2022-03-01'],"), s2);
        assertTrue(s2.contains("['y2',20,25,28]"), s2);

        String s3 = ECharts.chart().series("y2", "y1").xAxis("t", XAxis.ofTime()).plot("_tid", df3).renderChartScript();
    ...
    public void seriesType() {
        ...
        String s3 = ECharts.chart().series(SeriesOpts.ofBar(), "y1").plot("_tid", df2).renderChartScript();
        assertTrue(s3.contains("type: 'bar'"), s3);

        String s4 = ECharts.chart().series(SeriesOpts.ofPie(), "y1").plot("_tid", df2).renderChartScript();
