...
public class CartesianSeriesTest extends GenerateScriptHtmlTest {
    ...
    public void yAxisIndex() {
        ...
        String s2 = ECharts.chart().series(SeriesOpts.ofLine().yAxisIndex(2), "y1").generateScriptHtml("_tid", df2);
