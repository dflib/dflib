...
public class EChartTest extends GenerateScriptHtmlTest {
    ...
    @Test
    public void plot() {
        EChartHtml ch = EChart.chart().xAxis("x").series("y1", "y2").plot(df2);
    ...
    public void generateExternalScriptHtml() {
        ...
        String s1 = EChart.chart().generateExternalScriptHtml();
        ...
        String s2 = EChart.chart().scriptUrl("https://example.org/x.js").generateExternalScriptHtml();
    ...
    public void generateContainerHtml() {
        ...
        String s1 = EChart.chart().generateContainerHtml("_tid");
        assertEquals("<div id='_tid' style='width: 600px;height:400px;'></div>\n", s1);

        String s2 = EChart.chart().sizePixels(20, 10).generateContainerHtml("_tid");
    ...
    public void darkTheme() {
        ...
        String s2 = EChart.chart().darkTheme().generateScriptHtml("_tid", df1);
    ...
    public void svgRenderer() {
        ...
        String s2 = EChart.chart().renderAsSvg().generateScriptHtml("_tid", df1);
    ...
    public void svgRenderer_DarkTheme() {
        ...
        String s2 = EChart.chart().renderAsSvg().darkTheme().generateScriptHtml("_tid", df1);
        assertTrue(s2.contains("'dark',"), s2);
        assertTrue(s2.contains("renderer: 'svg'"), s2);
    }
}
