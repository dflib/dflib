...
class DynamicNumExpFactory extends NumericExpFactory {
    ...
    public NumExp<?> add(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumExp2("+", left, right, NumericExpFactory::add);
    }

    @Override
    public NumExp<?> sub(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumExp2("-", left, right, NumericExpFactory::sub);
    }

    @Override
    public NumExp<?> mul(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumExp2("*", left, right, NumericExpFactory::mul);
    }

    @Override
    public NumExp<?> div(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumExp2("/", left, right, NumericExpFactory::div);
    }

    @Override
    public NumExp<?> mod(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumExp2("%", left, right, NumericExpFactory::mod);
    }

    @Override
    public NumExp<?> abs(Exp<? extends Number> exp) {
        return new DynamicNumExp1("abs", exp, NumericExpFactory::abs);
    }

    @Override
    public NumExp<?> sqrt(Exp<? extends Number> exp) {
        return new DynamicNumExp1("sqrt", exp, NumericExpFactory::sqrt);
    }

    @Override
    public NumExp<?> negate(Exp<? extends Number> exp) {
        return new DynamicNegateExp(exp);
    }
    ...
    public NumExp<?> cumSum(Exp<? extends Number> exp) {
        return new DynamicNumExp1("cumSum", exp, NumericExpFactory::cumSum);
    }

    @Override
    public NumExp<?> sum(Exp<? extends Number> exp, Condition filter) {
        return new DynamicNumReduceExp1("sum", exp, (factory, resolved) -> factory.sum(resolved, null), filter);
    }

    @Override
    public NumExp<?> min(Exp<? extends Number> exp, Condition filter) {
        return new DynamicNumReduceExp1("min", exp, (factory, resolved) -> factory.min(resolved, null), filter);
    }

    @Override
    public NumExp<?> max(Exp<? extends Number> exp, Condition filter) {
        return new DynamicNumReduceExp1("max", exp, (factory, resolved) -> factory.max(resolved, null), filter);
    }

    @Override
    public NumExp<?> avg(Exp<? extends Number> exp, Condition filter) {
        return new DynamicNumReduceExp1("avg", exp, (factory, resolved) -> factory.avg(resolved, null), filter);
    }

    @Override
    public NumExp<?> median(Exp<? extends Number> exp, Condition filter) {
        return new DynamicNumReduceExp1("median", exp, (factory, resolved) -> factory.median(resolved, null), filter);
    }

    @Override
    public NumExp<?> quantile(Exp<? extends Number> exp, double q, Condition filter) {
        return new DynamicNumReduceExp1("quantile", exp, (factory, resolved) -> factory.quantile(resolved, q, null), filter);
    }

    @Override
    public NumExp<?> round(Exp<? extends Number> exp) {
        return new DynamicNumExp1("round", exp, NumericExpFactory::round);
    }

    @Override
    public NumExp<?> variance(Exp<? extends Number> exp, boolean usePopulationVariance) {
        return new DynamicNumReduceExp1(
                "variance",
                exp,
    ...
    public Condition eq(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumCondition2("=", left, right, NumericExpFactory::eq);
    }

    @Override
    public Condition ne(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumCondition2("!=", left, right, NumericExpFactory::ne);
    }

    @Override
    public Condition lt(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumCondition2("<", left, right, NumericExpFactory::lt);
    }

    @Override
    public Condition le(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumCondition2("<=", left, right, NumericExpFactory::le);
    }

    @Override
    public Condition gt(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumCondition2(">", left, right, NumericExpFactory::gt);
    }

    @Override
    public Condition ge(Exp<? extends Number> left, Exp<? extends Number> right) {
        return new DynamicNumCondition2(">=", left, right, NumericExpFactory::ge);
    }

    @Override
    public Condition between(Exp<? extends Number> left, Exp<? extends Number> from, Exp<? extends Number> to) {
        return new DynamicNumCondition3("between", "and", left, from, to, NumericExpFactory::between);
    }

    @Override
    public Condition notBetween(Exp<? extends Number> left, Exp<? extends Number> from, Exp<? extends Number> to) {
        return new DynamicNumCondition3("notBetween", "and", left, from, to, NumericExpFactory::notBetween);
    }
