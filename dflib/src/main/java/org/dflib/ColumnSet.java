...
public interface ColumnSet {
    ...
    /**
     * Parses the provided String into an expression and then executes one of the column expansion operations.
     * If the parsed expression produces Iterables (Lists, Sets, etc.), then {@link #expand(Exp)} will be called,
     * if it produces arrays - {@link #expandArray(Exp)}, and in all other cases, {@link #expandArray(Exp)} will be
     * called producing just a single extra column with unchanged values generated by the expression.
     *
     * @since 2.0.0
     */
