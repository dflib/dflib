...
public class GroupBy {
    ...
    /**
     * Parses the provided Strings into expressions and then recombines groups back to a single DataFrame with columns
    ...
    /**
     * Parses the provided Strings into expressions and recombines groups back to a DataFrame that contains columns
