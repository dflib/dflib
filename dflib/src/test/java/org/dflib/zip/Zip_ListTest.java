...
public class Zip_ListTest {
    ...
    @ParameterizedTest
    @MethodSource(value = "org.dflib.zip.TestZips#one")
    public void list_IncludeFolders(Zip zip) {
    ...
    public void list_noHidden(Zip zip) {
        List<String> names = zip.list().stream().map(ZipEntry::getName).sorted().collect(Collectors.toList());
    ...
    @ParameterizedTest
    @MethodSource(value = "org.dflib.zip.TestZips#two")
    public void list_hidden(Zip zip) {
    ...
    @ParameterizedTest
    @MethodSource(value = "org.dflib.zip.TestZips#two")
    public void list_hidden_Ext(Zip zip) {
    ...
    @ParameterizedTest
    @MethodSource(value = "org.dflib.zip.TestZips#one")
    public void list_include_predicate(Zip zip) {
        List<String> names = zip
    ...
    @ParameterizedTest
    @MethodSource(value = "org.dflib.zip.TestZips#two")
    public void list_include_predicate_withHidden(Zip zip) {
        List<String> names = zip
                .includeHidden()
    ...
    @Test
    public void list_IncludeFoldersAndHidden_WindowsZip() {
        List<String> names = TestZips.threeWin()
                .includeHidden()
                .list(true)
                .stream().map(ZipEntry::getName).sorted().collect(Collectors.toList());
