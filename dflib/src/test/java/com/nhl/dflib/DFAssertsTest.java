...
public class DFAssertsTest {
    ...
    public void testExpectRows_String() {
        ...
        DataFrame df = DataFrame.fromSequence(Index.withNames("a"), "a", "b", null);
        new DFAsserts(df, "a")
                .expectHeight(3)
                .expectRow(0, "a")
                .expectRow(1, "b")
    ...
    public void testExpectRows_ByteArray() {
        ...
        DataFrame df = DataFrame.fromSequence(Index.withNames("a"), new byte[]{3, 4, 5}, new byte[]{}, null);
        new DFAsserts(df, "a")
                .expectHeight(3)
    ...
    public void testExpectRows_ArryaTypeMismatch() {
        ...
        DataFrame df = DataFrame.fromSequence(Index.withNames("a"), new int[]{3, 4, 5});
