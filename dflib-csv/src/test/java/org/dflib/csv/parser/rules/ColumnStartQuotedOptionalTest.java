...
class ColumnStartQuotedOptionalTest {
    ...
    void marksColumnStart() {
        ...
        assertEquals(ParserState.END_QUOTED.ordinal(), ctx.stateOverride, "Should override state to COL_END_QUOTED");
    }
    ...
    private ParserRule newRule() {
        ...
        return new ColumnStartQuotedOptionalFactory().create(format);
    }
}
