 ...
 * Parquet Avro reader.
 */
public class HardwoodSaverTest {
    ...
    public class BigDecimalColumn {
        ...
        public void highPrecision() throws IOException {
            ...
            Hardwood.saver().decimalSize(20, 5).save(df, file);
        ...
        public void mediumPrecision() throws IOException {
            ...
            Path file = outBase.resolve("bigDecimalColumn.parquet");
            Hardwood.saver().decimalSize(18, 3).save(df, file);
        ...
        public void lowPrecision() throws IOException {
            ...
            Path file = outBase.resolve("bigDecimalColumn.parquet");
            Hardwood.saver().decimalSize(9, 4).save(df, file);
    ...
    public class LocalTimeColumn {
        ...
        public void localTimeColumnMillis() throws IOException {
            ...
            Hardwood.saver().timeUnit(TimeUnit.MILLIS).save(df, file);
    ...
    public class LocalDateTimeColumn {
        ...
        public void localDateTimeColumnMillis() throws IOException {
            ...
            Hardwood.saver().timeUnit(TimeUnit.MILLIS)
                    .save(df, file);
