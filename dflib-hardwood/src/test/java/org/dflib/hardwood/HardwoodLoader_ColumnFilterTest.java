...
public class HardwoodLoader_ColumnFilterTest {

    static File _4COL_FILE;

    @BeforeAll
    public static void setupCsvDirs() throws URISyntaxException {
        URI csvUri = HardwoodLoader_ColumnFilterTest.class.getResource("4col.parquet").toURI();
        _4COL_FILE = new File(csvUri).getAbsoluteFile();
    }

    @Test
    public void all() {
        DataFrame df = Hardwood.loader().load(_4COL_FILE);
