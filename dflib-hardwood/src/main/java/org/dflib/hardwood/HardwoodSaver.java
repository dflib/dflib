...
import org.dflib.hardwood.write.BatchFieldWriter;
import org.dflib.hardwood.write.ColumnMeta;
import org.dflib.hardwood.write.DataFrameSchema;
import org.dflib.hardwood.write.DecimalConfig;
import org.dflib.hardwood.write.SchemaCompiler;
import org.dflib.hardwood.write.WriteConfiguration;
...
public class HardwoodSaver {
    ...
    public HardwoodSaver createMissingDirs() {
        this.createMissingDirs = true;
        return this;
    }

    public HardwoodSaver timeUnit(TimeUnit timeUnit) {
        this.timeUnit = timeUnit;
        return this;
    }

    public HardwoodSaver decimalSize(int precision, int scale) {
        this.decimalConfig = new DecimalConfig(precision, scale);
        return this;
    }

    public HardwoodSaver compression(CompressionCodec compressionCodec) {
