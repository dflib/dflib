...
import org.dflib.hardwood.read.BatchReader;
import org.dflib.hardwood.read.ColumnBuilder;
import org.dflib.hardwood.read.SchemaProjector;
...
public class HardwoodLoader {
     ...
     */
    public HardwoodLoader cols(String... columns) {
     ...
     * @return this loader instance
     */
    public HardwoodLoader cols(int... columns) {
        this.schemaProjector = SchemaProjector.ofCols(columns);
        return this;
    }
     ...
     * @return this loader instance
     */
    public HardwoodLoader colsExcept(String... columns) {
     ...
     * @return this loader instance
     */
    public HardwoodLoader colsExcept(int... columns) {
        this.schemaProjector = SchemaProjector.ofColsExcept(columns);
        return this;
    }
