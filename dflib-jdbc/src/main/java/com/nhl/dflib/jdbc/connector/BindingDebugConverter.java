...
public class BindingDebugConverter {
    ...
    public BindingDebugConverter() {
        ...
        converters.put(LocalDate.class, this::convertToString);
        converters.put(LocalDateTime.class, this::convertToString);
        converters.put(LocalTime.class, this::convertToString);
