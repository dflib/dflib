...
public class JdbcContainerTool {
    ...
    private final JdbcDatabaseContainer maybeContainer;

    public static JdbcContainerTool create(String dbType) {

        // MySQL is special ... We need a "root" user to set up schema, and that requires an explicit container object
