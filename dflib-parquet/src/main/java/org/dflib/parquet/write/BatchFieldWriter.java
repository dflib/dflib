 ...
 *
 * <p>Hardwood's batch API takes whole arrays of physical values, which is the shape DFLib already stores its columns
 * in, so a primitive column reaches the writer without being visited value by value.
 *
 * @since 2.0.0
 */
@FunctionalInterface
